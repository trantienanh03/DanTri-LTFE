...
const Profile: React.FC = () => {
  ...
  const fullName = user.user_metadata?.full_name || 'Người dùng Dân trí';
  const email = user.email || '';

  const sidebarItems = [
    { icon: <User size={20} />, label: 'Thông tin tài khoản', active: true },
    { icon: <MessageSquare size={20} />, label: 'Hoạt động bình luận' },
    { icon: <Layout size={20} />, label: 'Bảng tin của bạn' },
    { icon: <Eye size={20} />, label: 'Tin đã xem' },
    { icon: <Bookmark size={20} />, label: 'Tin đã lưu' },
  ];
            ...
            <div className="social-linking-section">
              ...
              <div className="social-row">
                <div className="social-info">
                  ...
                  <span className="social-name">{fullName}</span>
                </div>
                <button className="social-action-btn disconnect">Ngắt kết nối</button>
              </div>
              <div className="social-row">
                <div className="social-info">
                ...
                <button className="social-action-btn connect">Kết nối</button>
              </div>
              <div className="social-row">
                <div className="social-info">
